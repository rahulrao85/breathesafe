...
SLIDE4_OPPORTUNITIES = (
    ...
    "screening. Existing tools either track individuals (consumer "
    "wearables, personal sleep apps) or stay at country-level "
    "statistics.\n\n"
    ...
    "- vs. consumer wearables and personal sleep apps: zero personal "
    "data, zero diagnostic claim, public-health scope.\n"
